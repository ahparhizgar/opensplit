...
object AuthValidation {
    ...
    fun validateSignUp(email: String, password: String): ValidationResult = validateCredentials(email, password)

    fun validateSignIn(email: String, password: String): ValidationResult = validateCredentials(email, password)
