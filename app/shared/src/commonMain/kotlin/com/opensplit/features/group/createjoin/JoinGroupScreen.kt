  ...
  Scaffold(
    ...
    Column(modifier = Modifier.fillMaxSize().padding(padding).padding(16.dp)) {
      OutlinedTextField(
          ...
          modifier = Modifier.fillMaxWidth().testTag("group-invite-code"),
          singleLine = true,
      )
      state.fieldErrors["inviteCode"]?.let {
        Text(
            ...
            modifier = Modifier.testTag("group-invite-code-error"),
        )
      }
...
private fun JoinGroupScreenPreview() {
  OpenSplitTheme { JoinGroupScreen(FakeJoinGroupComponent()) }
}
